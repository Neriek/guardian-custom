...
#                print(Fore.LIGHTWHITE_EX + 'Cloud service down' + Fore.RESET)
        ...
        print(Fore.LIGHTWHITE_EX + '===============================\nOriginal program by DigitalArc\n    Custom build for Maze\n===============================\n' + Fore.RESET)
        options = {
            'type': 'list',
            'name': 'option',
...
#                }
        ...
        if option == 'solo':
            ...
            print(Fore.LIGHTWHITE_EX + 'Running: "' + Fore.LIGHTRED_EX + 'Blacklist' +
                  Fore.LIGHTWHITE_EX + '" Press "' + Fore.LIGHTRED_EX + 'CTRL + C' + Fore.LIGHTWHITE_EX +
                  '" to stop.' + Fore.RESET)
            try:
                while True:
            ...
            collector.start()
            for i in tqdm(range(10), ascii=True, desc='Identifying Losers'):
                time.sleep(1)
            collector.stop()
...
#            cloud_list = config.get('friends')
            ...
            for x in cloud_list:
                if x.get('enabled'):
                    mylist.append(x.get('ip'))
            print(Fore.LIGHTWHITE_EX + 'Ejecting Losers...' + Fore.RESET)
            time.sleep(2)
            whitelist = Whitelist(ips=mylist)
            whitelist.start()
            time.sleep(10)
            ...
            print(Fore.LIGHTWHITE_EX + 'Ditching Losers...' + Fore.RESET)
            time.sleep(2)
            whitelist = Whitelist(ips=[])
            whitelist.start()
            time.sleep(10)
...
if __name__ == '__main__':
    ...
    if not ctypes.windll.shell32.IsUserAnAdmin():
        print(Fore.LIGHTWHITE_EX + 'RUN AS ADMINISTRATOR DUMBASS' + Fore.RESET)
        Logger().info('Started without admin')
        input('Press enter to exit.')
        sys.exit()
    Logger().info('Starting up')
    print(Fore.LIGHTWHITE_EX + 'Starting up...' + Fore.RESET)
